...
class QuoteByDaySession(TokyoCEHistoricalDBBaseModel):
    """
    Database model for "Quotes for All Products by Session (Day Session)"
    """
    __tablename__ = 'quotes_by_day_session'
