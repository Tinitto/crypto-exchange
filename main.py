...
from app.services.tokyo_commodities_exchange.export_site_to_db import TOKYO_C_E_export_site_TO_DB_CONTROLLERS
...
def get_graph(**options):
    ...
    for controller in TOKYO_C_E_export_site_TO_DB_CONTROLLERS:
        graph.add_chain(
            controller.extract,
            controller.transform,
            controller.load,
